...
export const metadata: Metadata = {
  title: "Implement — ERC-8213",
  description:
    "How wallet builders compute and display the four ERC-8213 digests, with reference code and edge cases.",
};
    ...
    <>
      <PageHeader
        ...
        title={
          <>
            How to ship
            <span className="serif-italic text-ink-dim"> ERC-8213.</span>
          </>
        }
        description={
          <>
            Two flows, four values, one rule: a signer must be able to read at
            least one fingerprint before approving. This page walks through each
            flow with reference code, then catalogues the edge cases that bite.
          </>
        }
      />
        ...
        <div className="grid grid-cols-12 gap-6 mb-6">
          ...
          <div className="col-span-12 md:col-span-10">
            ...
            <p className="mt-4 text-ink-dim text-base max-w-[640px] leading-relaxed">
              The four digests divide cleanly along one axis: whether the user
              is signing typed data or authorising a raw transaction.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <Frame className="p-6 md:p-8">
            <div className="flex items-baseline gap-3 mb-4">
              ...
              <h3 className="text-lg uppercase tracking-[0.15em]">
                EIP-712 typed data
              </h3>
            </div>
            <p className="serif-italic text-ink-dim text-base mb-6">
              eth_signTypedData_v4 and friends.
            </p>
            <ul className="space-y-3 text-sm text-ink-dim leading-relaxed">
              <li>
                <span className="text-accent mr-2">→</span>Compute{" "}
                <code className="inline">domainHash</code>,{" "}
                <code className="inline">messageHash</code>,{" "}
                <code className="inline">digest</code>.
              </li>
              <li>
                <span className="text-accent mr-2">→</span>
                <span className="text-ink">Display</span>{" "}
                <code className="inline">digest</code> alone, or all three.
              </li>
              <li>
                <span className="text-accent mr-2">→</span>Place the digest where
                a signer reads it before approving — not three taps deep.
              </li>
            </ul>
          </Frame>
          <Frame className="p-6 md:p-8">
            ...
            <ul className="space-y-3 text-sm text-ink-dim leading-relaxed">
              <li>
                <span className="text-accent mr-2">→</span>Compute{" "}
                <code className="inline">calldataDigest</code>.
              </li>
              <li>
                <span className="text-accent mr-2">→</span>
              ...
              <li>
                <span className="text-accent mr-2">→</span>Do not include chainId
                in the preimage.
              </li>
            </ul>
          </Frame>
      ...
      <section className="mx-auto max-w-[1280px] px-6 md:px-10 mt-24">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-10">
            <h2 className="text-2xl md:text-4xl leading-tight">
              <span className="serif-italic text-ink-dim">Display, not </span>
              decoration.
            </h2>
            <ol className="editorial mt-10 text-base text-ink-dim leading-relaxed max-w-[700px]">
              <li>
                <span className="text-ink">Always 0x-prefixed.</span> Lower- or
                upper-case hex; do not invent a custom encoding.
              </li>
              <li>
                <span className="text-ink">Never truncate without a reveal.</span>{" "}
                If space forces an ellipsis, give the user a way to read the full
                32-byte value before signing.
              </li>
              <li>
                <span className="text-ink">Use a monospace face.</span> Variable
                fonts make digit comparison harder than it needs to be.
              </li>
              <li>
                <span className="text-ink">Group bytes for scanability.</span>{" "}
                Optional, but four- or eight-byte groups help eyeballed
                comparison against a hardware wallet screen.
              </li>
              <li>
                <span className="text-ink">Label every value.</span> A digest
                without a name is a number; a labelled digest is evidence.
              </li>
            </ol>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-[1280px] px-6 md:px-10 mt-24">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-10">
            ...
            <p className="mt-4 text-ink-dim text-base max-w-[640px] leading-relaxed">
              The two non-trivial bits: stripping{" "}
              <code className="inline">EIP712Domain</code> from the message
              struct hash, and length-prefixing the calldata before keccak.
      ...
      <section className="mx-auto max-w-[1280px] px-6 md:px-10 mt-24 mb-32">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-10">
            <h2 className="text-2xl md:text-4xl leading-tight">
              <span className="serif-italic text-ink-dim">Where </span>
              wallets get this wrong.
            </h2>
              ...
              {[
                {
                  ...
                  b: (
                    <>
                      When computing <code className="inline">messageHash</code>,
                      remove <code className="inline">EIP712Domain</code> from
                      the types map. Otherwise viem-style libraries refuse and
                      ad-hoc implementations silently produce a different hash.
                    </>
                  ),
                },
                {
                  ...
                  b: (
                    <>
                      The length is a 32-byte big-endian{" "}
                      <code className="inline">uint256</code> — not a varint, not
                      4 bytes, not the byte length of the hex string.
                    </>
                  ),
                },
                {
                  ...
                  b: (
                    <>
                      Deliberately. The same calldata produces the same digest
                      across forks, which is the property auditors need. ChainId
                      already appears in the EIP-712 domain hash where it
                      belongs.
                    </>
                  ),
                },
                {
                  ...
                  b: (
                    <>
                      Pick one and stick with it. Mixed case in displayed
                      digests turns &quot;byte equality&quot; into a vibes-based
                      comparison.
                    </>
                  ),
                },
                {
                  ...
                  b: (
                    <>
                      Console output isn&apos;t display. The signer needs to see
                      the digest in the same surface as the approval button.
                    </>
                  ),
                },
                {
                  ...
                  b: (
                    <>
                      A wallet that signs both EIP-712 and raw calldata must
                      implement <em className="serif-italic text-ink">both</em> digest types.
                      Implementing one makes the other look more dangerous than
                      it should.
                    </>
                  ),
                },
                ...
                <div
                  key={e.t}
                  className="border border-rule p-5 transition-colors hover:border-rule-strong"
                >
