    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1280px] px-6 md:px-10 pt-12 md:pt-14 pb-14 md:pb-20">
          {/* Compact kicker + tagline */}
          <div className="grid grid-cols-12 gap-6 items-end mb-8 md:mb-10">
            <div
              className="col-span-12 md:col-span-3 reveal"
          ...
          {/* The comparison — now the visual anchor */}
          <div
          ...
          >
            <div className="col-span-12 md:col-span-6 flex flex-col">
              <div className="flex items-baseline justify-between mb-4 gap-3">
                ...
                <span className="text-ink-faint text-xs md:text-sm tracking-[0.25em]">
                  A
                </span>
              </div>
            ...
            <div className="col-span-12 md:col-span-6 flex flex-col">
              <div className="flex items-baseline justify-between mb-4 gap-3">
                ...
                <span className="text-accent text-xs md:text-sm tracking-[0.25em]">
                  B
                </span>
              </div>
              <Frame className="p-6 md:p-8 flex-1 flex flex-col">
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  <div className="serif-italic text-ink-dim text-base md:text-lg mt-5 max-w-[440px]">
                    Same payload. Reproducible from the calldata alone, on any
                    device, on any chain.
                  </div>
                </div>
      ...
      {/* THE PITCH — description + CTAs, intentionally below the fold */}
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 md:col-span-9">
              <p className="text-base md:text-xl text-ink-dim leading-relaxed max-w-[720px]">
                A wallet asks you to sign. You see a hex blob the length of a
                paragraph, or worse — nothing at all.{" "}
                <span className="serif-italic text-ink">ERC-8213</span>{" "}
                standardises four short fingerprints so a signer can
                independently verify what is being signed, on any device,
                against any source of truth.
              </p>
          ...
          <div className="col-span-12 md:col-span-9">
            <h2 className="text-3xl md:text-5xl leading-[1.05] tracking-[-0.02em] text-ink">
              ...
              <span className="serif-italic text-ink-dim">
                One vocabulary every wallet should speak.
              </span>
            </h2>
            <p className="mt-6 text-ink-dim text-base md:text-lg leading-relaxed max-w-[640px]">
              ERC-8213 doesn&apos;t invent new cryptography. It standardises the names,
              encodings, and display rules for values that already exist — so you can
              compare what your wallet shows to what an independent verifier shows,
              byte for byte.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-10">
          <div className="lg:col-span-2">
            <DigestPanel
              ...
              formula={
                <>
                  keccak256(<span className="text-accent">0x1901</span> ‖
              ...
              desc={
                <>
                  The single 32-byte value an ECDSA signer signs for typed data.
                  Wallets <em className="serif-italic text-ink">should</em> display this — alone or
                  alongside the domain and message hashes — when prompting for an
                  EIP-712 signature.
                </>
              }
            />
          ...
          <DigestPanel
            ...
            desc={
              <>
                A fingerprint of the dapp&apos;s claimed identity: name, version,
                chainId, contract. Compare to a known-good source to detect
                rebinding to the wrong app.
              </>
            }
          />
          <DigestPanel
            ...
            desc={
              <>
                A fingerprint of the typed message itself. Two requests with
                identical message hashes ask you to authorise the same thing.
              </>
            }
          />
          <div className="lg:col-span-2">
            <DigestPanel
              ...
              formula={
                <>
                  keccak256(<span className="text-accent">uint256(len)</span> ‖
                  calldata)
                </>
              }
              value={cdDigest}
              desc={
                <>
                  For raw transactions. Length-prefixed so two payloads
                  sharing a common prefix never collide. <span className="text-ink">chainId is deliberately omitted</span>{" "}
                  so the same digest can be reproduced and compared across forks
                  and replays.
                </>
              }
            />
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 md:col-span-9">
              <h2 className="text-3xl md:text-5xl leading-[1.05] tracking-[-0.02em]">
                <span className="serif-italic text-ink-dim">Why a wallet should display </span>
                a fingerprint <span className="serif-italic text-ink-dim">at all.</span>
              </h2>

              <ol className="editorial mt-12 text-ink-dim text-base md:text-lg leading-relaxed max-w-[700px]">
                <li>
                  <span className="text-ink">Independent verification.</span> A
                  signer can reproduce the digest from the same inputs on a separate
                  device — a hardware wallet, a script, a colleague&apos;s laptop —
                  and confirm equality before signing.
                </li>
                <li>
                  <span className="text-ink">Defense against UI lies.</span> If a
                  malicious dapp shows you one message and asks the wallet to sign
                  another, the digest changes. A human-readable description can be
                  forged; a hash cannot.
                </li>
                <li>
                  <span className="text-ink">Auditable provenance.</span> Auditors,
                  multisig signers, and incident responders can refer to a single
                  canonical fingerprint instead of arguing over reformatted JSON.
                </li>
                <li>
                  <span className="text-ink">Complement, not replace.</span> ERC-8213
                  sits below ERC-7730&apos;s human-readable layer. Description for
                  the eye, fingerprint for the audit trail.
                </li>
              </ol>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-[1280px] px-6 md:px-10 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/implement" className="group block">
            <Frame className="p-6 h-full transition-colors hover:border-accent">
              <div className="flex items-baseline justify-between mb-4">
                <span className="section-num">§ 03</span>
                <span className="text-ink-faint text-xs group-hover:text-accent transition-colors">
                  →
                </span>
              </div>
              <h3 className="text-xl leading-snug">
                For wallet builders
                <span className="serif-italic text-ink-dim block mt-1 text-base">
                  what to compute, when to show it.
                </span>
              </h3>
            </Frame>
          </Link>
          <Link href="/verify" className="group block">
            <Frame className="p-6 h-full transition-colors hover:border-accent">
              ...
              <h3 className="text-xl leading-snug">
                For signers
                <span className="serif-italic text-ink-dim block mt-1 text-base">
                  reproduce a wallet&apos;s digests in your browser.
                </span>
              </h3>
            </Frame>
          </Link>
          <Link href="/compute" className="group block">
            <Frame className="p-6 h-full transition-colors hover:border-accent">
              <div className="flex items-baseline justify-between mb-4">
